In order to change the Plex video quality settings on Apple iOS devices (e.g. iPhones & iPads). From the home screen hit the "hamburger menu" button in the upper left hand corner.
